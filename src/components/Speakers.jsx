...
function Speakers() {
    ...
    return (
        <div className="w-full  py-8" style={{backgroundColor:'#060e2e'}}>
            <h2 className="lg:font-bold text-white lg:text-5xl text-3xl  text-center font-serif py-16">Meet our first speakers</h2>
            <div className="flex w-full lg:w-11/12 flex-wrap mx-auto ">
