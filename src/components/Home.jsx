...
function Home() {
    return (
        <div  className="lg:flex pt-20" style={{backgroundColor:'#121c4b'}}>
            <div className="lg:w-1/2 text-neutral-100 flex flex-col items-end">
                ...
                <div className="w-max lg:w-9/12  mx-auto bg-neutral-100/5 text-xl flex flex-col items-center space-y-5 p-10 lg:px-5 lg:py-14 rounded-xl ">
                    <h2><span>O</span> Where? When? What time?</h2>
                    <p><span>Kyiv, Palace of Culture</span></p>
                    <div className="flex space-x-5">
                        <p href="">15-16.04.2024</p>
                        <p href="">Start at 10:00</p>
                    </div>
                </div>
                <div className="flex w-full lg:w-9/12 mx-auto lg:my-10    justify-between  flex-col lg:flex-row  font-bold space-y-5 lg:space-y-0 lg:space-x-5 items-center my-5">
